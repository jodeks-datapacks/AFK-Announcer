...
execute as @a at @s[scores={afkannouncer.afk_time=4800..},tag=!afkannouncer.afk] run function afkannouncer:announce_afk
execute as @a at @s[scores={afkannouncer.afk_time=4800..}] run tag @s add afkannouncer.afk
