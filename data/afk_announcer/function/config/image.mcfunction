function afk_announcer:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    ...
    "",\
    [{translate: "jodek.datapack_version", fallback: "Datapack version: ", "color": "#00a800"}, {"text": "v4.0.1", "color": "#54fc54"}],\
    ...
    [{"text": "modrinth.com/datapack/afk-announcer", "color": "#a800a8"}],\
    "",\
    "",\
    "",\
    "",\
