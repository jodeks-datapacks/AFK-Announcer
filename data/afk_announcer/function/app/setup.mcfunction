...
team add default
execute unless score &invisible_player_name jodek.installed matches 1 run team modify default nametagVisibility always

team add afk_team
team modify afk_team collisionRule pushOwnTeam
execute unless score &invisible_player_name jodek.installed matches 1 run team modify afk_team nametagVisibility always

team add afk_overworld
team modify afk_overworld collisionRule pushOwnTeam
execute unless score &invisible_player_name jodek.installed matches 1 run team modify afk_overworld nametagVisibility always

team add afk_nether
team modify afk_nether collisionRule pushOwnTeam
execute unless score &invisible_player_name jodek.installed matches 1 run team modify afk_nether nametagVisibility always

team add afk_end
team modify afk_end collisionRule pushOwnTeam
execute unless score &invisible_player_name jodek.installed matches 1 run team modify afk_end nametagVisibility always
